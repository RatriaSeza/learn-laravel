            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted">
                        By:
                        <a class="text-secondary text-decoration-none" href="/posts?author={{ $posts[0]->author->username }}">
                            {{ $posts[0]->author->name }}
                        </a>
                        in
                        <a class="text-secondary text-decoration-none" href="/posts?category={{ $posts[0]->category->slug }}">
